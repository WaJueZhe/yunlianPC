    ...
    <div class="page" v-show="page">
      ...
      <div class="echarts">
        <div class="e-box">
          <ul class="list">
            <li class="item">
              <div id="lastWeek" style="width: 450px;height: 350px;"></div>
            </li>
            <li class="item">
              <div id="lastWeek2" style="width: 450px;height: 350px;"></div>
            </li>
            <li class="item">
              <div id="lastWeek3" style="width: 450px;height: 350px;"></div>
            </li>
          </ul>
        </div>
        <div class="line-chart">
          <div class="l-box">
            ...
            <div id="lastWeek4" style="width: 100%;height: 600px;"></div>
          </div>
        </div>
      </div>
      <div class="text-box">
...
export default {
  ...
  mounted() {
    this.$nextTick(function() {
      this.drawPie("lastWeek");
    });
    this.$nextTick(function() {
      this.drawPie2("lastWeek2");
    });
    this.$nextTick(function() {
      this.drawPie3("lastWeek3");
    });
    this.$nextTick(function() {
      this.drawPie4("lastWeek4");
    });
  },
  components: {
    educe
