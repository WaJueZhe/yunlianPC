<template>
    <div style="width:100%">
        <el-cascader :options="pcdOptions" v-model="selectedOptions" filterable clearable @change="valueChanged" :style="styleVal"></el-cascader>  
    </div>
</template>

<script>
export default {
  props: ["tempPcdText","styleVal"], //必须，实现从父组件向子组件赋值用
  data() {
    return {
      pcdOptions: [
        {
        ...
        },
        {
          ...
          children: [
            ...
            },
            {
              value: "469033",
              label: "中沙群岛的岛礁及其海域",
              children: [{ value: "469033", label: "中沙群岛的岛礁及其海域" }]
            },
            {
              value: "469024",
              label: "临高县",
            ...
            },
            {
              value: "469003",
              label: "儋州市",
              children: [{ value: "469003", label: "儋州市" }]
            },
            {
              value: "469032",
              label: "南沙群岛",
              children: [{ value: "469032", label: "南沙群岛" }]
            },
            {
              value: "469021",
              label: "定安县",
            ...
            },
            {
              value: "469031",
              label: "西沙群岛",
              children: [{ value: "469031", label: "西沙群岛" }]
            },
            {
              value: "469028",
              label: "陵水黎族自治县",
  ...
  created() {
    this.selectedOptions = this.tempPcdText.split(",");
  },
  methods: {
    valueChanged() {
      let names = ["", "", ""];
