...
<div class="page-box">
  <div class="page" v-show="page">
    ...
    <div class="echarts">
      <div class="e-box">
        <ul class="list">
          <li class="item"><div id="thisMonth" style="width: 450px;height: 350px;"></div></li>
          <li class="item"><div id="thisMonth2" style="width: 450px;height: 350px;"></div></li>
          <li class="item"><div id="thisMonth3" style="width: 450px;height: 350px;"></div></li>
        </ul>
      </div>
      <div class="line-chart">
        <div class="l-box">
          ...
          <div id="thisMonth4" style="width: 100%;height: 600px;"></div>
        </div>
      </div>
    </div>
    <div class="text-box">
...
export default {
  ...
  methods: {
    ...
    series: [
        ...
        },
        {
            ...
            type:'line',
            stack: '总量',
            data:[220, 182, 191, 234, 290, 330, 310,220, 182, 191, 234, 290, 330, 310,220, 182, 191, 234, 290, 330, 310,220, 182, 191, 234, 290, 330, 310,420,360]
        },
        {
            name:'未完成数',
            type:'line',
            stack: '总量',
            data:[150, 232, 201, 154, 190, 330, 410, 200, 450, 380, 150, 232, 201, 154, 190, 330, 410, 200, 450, 380, 150, 232, 201, 154, 190, 330, 410, 200, 380]
        }
    ]
        })
    },
  ...
  mounted () {
     this.$nextTick(function() {
        this.drawPie('thisMonth')
    });
     this.$nextTick(function() {
        this.drawPie2('thisMonth2')
    });
     this.$nextTick(function() {
        this.drawPie3('thisMonth3')
    });
    this.$nextTick(function() {
        this.drawPie4('thisMonth4')
    })
  },
  components: {
    educe,
