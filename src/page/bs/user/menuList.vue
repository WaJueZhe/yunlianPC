        ...
        <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
            ...
            <el-col :span="24" style="padding-bottom: 0px;">
                <el-form :inline="true" :model="filters">
                    <el-form-item>
                        <el-input v-model="filters.nodeName" placeholder="菜单权限名称" style="min-width: 120px;"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-input v-model="filters.nodeCode" placeholder="菜单权限代码" style="min-width: 120px;"></el-input>
                    </el-form-item>
                    <el-form-item>
            ...
            <!--列表-->
            <el-table :data="taskCateList" highlight-current-row v-loading="loading" style="width: 100%;" stripe :border="true" class="menuListTable">
                <el-table-column type="index" label="序号" width="50">
                </el-table-column>
                <el-table-column prop="id" label="id" v-if="false"></el-table-column>
                <el-table-column prop="nodeName" label="菜单权限名称" align="center" sortable>
                </el-table-column>
                <el-table-column prop="nodeCode" label="菜单权限代码" align="center" sortable>
                </el-table-column>
                ...
                <el-row :gutter="10">
                    ...
                    <el-col :span="12">
                        <el-form-item label="菜单权限代码" prop="nodeCode">
                            <el-input v-model="addForm.nodeCode" auto-complete="off" placeholder="请输入菜单权限代码,格式，例如一级：m001 "></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row :gutter="10">
                    <el-col :span="12">
                        <el-form-item label="父级菜单代码" prop="parentNodeCode">
                            <el-input v-model="addForm.parentNodeCode" auto-complete="off" placeholder="请输入父级菜单代码：0"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
...
.menuListTable .el-table__row .el-button {
  padding: 0;
  color: #409eff;
  border: none;
  padding-right: 3px;
