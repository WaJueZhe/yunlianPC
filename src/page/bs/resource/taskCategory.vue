<template>
    <el-row class="warp" style="margin-bottom:50px">
        <el-col :span="24" class="warp-breadcrum" style="padding:10px;">
            <app-title :title="taskCateTiele"></app-title>
        </el-col>
        ...
        <el-col :span="24" class="warp-main" v-loading="loading" element-loading-text="拼命加载中">
            ...
            <el-col :span="24" style="padding-bottom: 0px;">
                ...
                <!--列表-->
                <el-table :data="taskCateList" highlight-current-row v-loading="loading" style="width:100%;" stripe :border="true" class="taskCategoryTable">
                    <el-table-column type="index" label="序号" width="50" align="center">
                    </el-table-column>
                    <el-table-column prop="id" label="id" v-if="false" align="center"></el-table-column>
                    <el-table-column prop="categoryDesc" label="项目名称" align="center" sortable>
                    </el-table-column>
                    <el-table-column prop="remarks" label="项目描述" align="center" sortable>
                    </el-table-column>
                    ...
                    <template slot-scope="scope" >
                        ...
                        <el-button @click="delUser(scope.$index,scope.row)" size="small">删除</el-button>
                    </template>
                    </el-table-column>              
                </el-table>
            </el-col>
            ...
            <el-dialog title="新增" :visible.sync="addFormVisible" :close-on-click-modal="false" custom-class="myClass">
                <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
                    ...
                    <el-form-item label="描述" prop="remarks">
                        <el-input v-model="addForm.remarks" auto-complete="off" placeholder="请输入备注"  style="width:70%"></el-input>
                    </el-form-item>
                </el-form>
            ...
            <el-dialog title="编辑" :visible.sync ="editFormVisible" :close-on-click-modal="false" custom-class="myClass">
                ...
                <el-form-item label="名称" prop="categoryDesc">
                    <el-input v-model="editForm.categoryDesc" auto-complete="off" :disabled="true"  style="width:70%"></el-input>
                </el-form-item>
                <el-form-item label="描述" prop="remarks">
    ...
    data(){
        ...
        var checkExistsCateDesc = (rule, value, callback) =>{
            if (this.addForm.categoryDesc != ''){
                let p = {cateDesc: this.addForm.categoryDesc};
                this.axios.post(`${this.api.baseURL}/bsresource/getCountByCateDesc`, p).then(res =>{
    ...
    methods:{
        ...
        delUser(index, row){
                ...
                {confirmButtonText: '确定', cancelButtonText: '取消', type: 'warning'}).then(() => 
            {
                let that = this
                let p = {id: row.id};
                that.axios.post(`${this.api.baseURL}/bsresource/deleteTaskCategory`, p).then(function(result){
                    //console.log(result);
...
.taskCategoryTable .el-table__row .el-button {
  padding: 0;
  color: #409eff;
  border: none;
  padding-right: 3px;
