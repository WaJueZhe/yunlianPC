  ...
  <div>
    <el-row class="warp" style="padding:2px;margin-bottom:50px">
        ...
        <el-form :model="formDate" :rules="rules" ref="formDate" :label-position="labelPosition" label-width="80px">
          ...
          <el-form-item v-if="formDate.isTop" label="结束时间" prop="topDate">
            <el-date-picker
          ...
          <el-form-item label="公告内容" prop="context">
            <quill-editor ref="myTextEditor" style="width:95%" v-model="formDate.context" :config="editorOption"></quill-editor>
          </el-form-item>
          <el-form-item>
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.formDate.isTop) {
        ...
        this.articleInfo.topTime = moment(this.formDate.topDate).format("YYYY-MM-DD");
      } else {
